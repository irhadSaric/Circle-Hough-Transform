...
def sobel_filter(image):
    ...
    # kx = np.array([[-1, -2, 0, 2, 1], [-2, -3, 0, 3, 2], [-3, -5, 0, 5, 3], [-2, -3, 0, 3, 2], [-1, -2, 0, 2, 1]], np.float32)
    # ky = np.array([[1, 2, 3, 2, 1], [2, 3, 5, 3, 2], [0, 0, 0, 0, 0], [-2, -3, -5, -3, -2], [-1, -2, -3, -2, -1]], np.float32)
...
def main(image_name, min_radius, max_radius, gaussian_kernel_dimension = 5, lowThresholdRatio = 0.15, highThresholdRatio = 0.25):
    ...
    cv2.imwrite('rez'+image_name, img_orig)

main("mala1.jpg", 34, 36)
# main("sareni.png", 20, 21, 3)
# main("mala2.jpg", 56, 68, 15)
# main("bilijar2.jpg", 50, 75, 3)
# main("squares2.png", 22, 29)